...
func (_EventFactory *EventFactoryCaller) Admin(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _EventFactory.contract.Call(opts, &out, "admin")
...
//
// Solidity: function admin() view returns(address)
func (_EventFactory *EventFactorySession) Admin() (common.Address, error) {
	return _EventFactory.Contract.Admin(&_EventFactory.CallOpts)
}

// Admin is a free data retrieval call binding the contract method 0xf851a440.
//
// Solidity: function admin() view returns(address)
func (_EventFactory *EventFactoryCallerSession) Admin() (common.Address, error) {
	return _EventFactory.Contract.Admin(&_EventFactory.CallOpts)
}
...
// CreateTicket is a paid mutator transaction binding the contract method 0xa56227ec.
//
// Solidity: function createTicket(address eventAddress, string name, uint256 maxSupply, string ticketHash) returns(address)
func (_EventFactory *EventFactoryTransactor) CreateTicket(opts *bind.TransactOpts, eventAddress common.Address, name string, maxSupply *big.Int, ticketHash string) (*types.Transaction, error) {
	return _EventFactory.contract.Transact(opts, "createTicket", eventAddress, name, maxSupply, ticketHash)
}

// CreateTicket is a paid mutator transaction binding the contract method 0xa56227ec.
//
// Solidity: function createTicket(address eventAddress, string name, uint256 maxSupply, string ticketHash) returns(address)
func (_EventFactory *EventFactorySession) CreateTicket(eventAddress common.Address, name string, maxSupply *big.Int, ticketHash string) (*types.Transaction, error) {
	return _EventFactory.Contract.CreateTicket(&_EventFactory.TransactOpts, eventAddress, name, maxSupply, ticketHash)
}

// CreateTicket is a paid mutator transaction binding the contract method 0xa56227ec.
//
// Solidity: function createTicket(address eventAddress, string name, uint256 maxSupply, string ticketHash) returns(address)
func (_EventFactory *EventFactoryTransactorSession) CreateTicket(eventAddress common.Address, name string, maxSupply *big.Int, ticketHash string) (*types.Transaction, error) {
	return _EventFactory.Contract.CreateTicket(&_EventFactory.TransactOpts, eventAddress, name, maxSupply, ticketHash)
}
