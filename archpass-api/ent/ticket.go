...
func (e TicketEdges) OrdersOrErr() ([]*Order, error) {
	if e.loadedTypes[2] {
		return e.Orders, nil
	}
...
// QueryOrders queries the "orders" edge of the Ticket entity.
func (t *Ticket) QueryOrders() *OrderQuery {
	return NewTicketClient(t.config).QueryOrders(t)
}
